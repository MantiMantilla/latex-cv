...
\begin{cventries}
	...
	{Center for Asian Languages} % Organization/group
	{Colombia} % Location
	...
	%---------------------------------------------------------
	\cventry{Kite-surfer} % Affiliation/role
	{ChivorKite} % Organization/group
	{Colombia} % Location
	...
	{Aug. 2014 {-} Present} % Date(s)
	{
		\begin{cvitems} % Description(s) of experience/contributions/knowledge
			...
			\item {Have been learning the piano since 2014 and recently took to learning the guitar.}
		\end{cvitems}
	}
