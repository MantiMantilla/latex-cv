...
\begin{cventries}
	...
	%---------------------------------------------------------
	\cventry{Software Developer, Data Engineer, \& Data Scientist} % Job title
	{Freelance} % Organization
	{Remote} % Location
	{Jan. 2018 {-} Present} % Date(s)
	{
		\begin{cvitems} % Description(s) of tasks/responsibilities
			\item {Implemented mathematical optimization models with heuristic algorithms in Java and Python along with automated ETL tools for a FinTech startup to efficiently decide individual but mutually dependent portfolios of around 500 customers (Integrity).}
			...
			\item {Held talks at UniAndes on Mathematical Modeling, Cloud Architecture, Machine Learning technologies, NLP, ETL with Spark and Kafka with JVM languages, Business Intelligence with Google Looker Studio, among other topics.}
			...
			\item {Tutored undergraduate and graduate students on the subjects of Operations Research, Statistics and Data Science, and Software Development in Java and Python.}
		\end{cvitems}
	}
	...
	{Jan. 2021 {-} Jul. 2023} % Date(s)
	{
		\begin{cvitems} % Description(s) of tasks/responsibilities
			...
			\item {Developed an elastic cloud solution for hundreds of students to access predefined Java, Python, and R environments on-demand.}
	...
	{Jan. 2021 {-} Jul. 2021} % Date(s)
	{
		\begin{cvitems} % Description(s) of tasks/responsibilities
			...
			\item {Developed optimization algorithms for the inverse kinematics problem for robot arms, simulated the system in Unity (C++, Java, \& C\#), and built a physical and functional testing cell integrating all of these technologies in the context of inventory management.}
		\end{cvitems}
	}
