...
\begin{cventries}
	...
	%---------------------------------------------------------
	\cventry{Senior Data Engineer and Analyst} % Job title
	{BetOnline} % Organization
	{Remote} % Location
	{Dec. 2023 {-} Present} % Date(s)
	{
		\begin{cvitems} % Description(s) of tasks/responsibilities
			\item {SQL Server Database administration and Data Warehouse development, to be consumed by business analysts and for internal business tools.}
			\item {Deployed a new data warehouse solution in Databricks, adhering to the medallion architecture and optimizing query performance by up to 100 times for some essential analytics products.}
			...
			\item {Developed dashboards in Tableau and Dash. Charts were reviewed directly and frequently by the CEO.}
			\item {Deployment of internal tools with Airflow, Docker, and SSIS.}
			\item {Market analysis of promotions, odds, and overall strategy. Participated in important stewardship meetings.}
			\item {Created testing pipelines with web automation frameworks like Beautiful Soup, Selenium, Requests and PyTest.}
			\item {Build and report on player acquisition and revenue forecasting. Used traditional financial model forecasting, and advanced ML.}
			\item {Implemented and put in production mathematical optimization tools for marketing campaign resources, fraud mitigation, and complex payment routing.}
		\end{cvitems}
	}
	...
	{Jan. 2018 {-} Nov. 2023} % Date(s)
	{
		\begin{cvitems} % Description(s) of tasks/responsibilities
			...
			\item {Implemented said mathematical models in Python and Java along with automated ETL tools with which the analyst team could tune the outcome to their preference.}
			...
			\item {Held talks at UniAndes on Mathematical Modeling, Cloud Architecture, Machine Learning technologies, NLP, ETL with Hadoop, Spark and Kafka, Business Intelligence with Google Looker Studio, among other topics.}
	...
	{UniAndes (University of the Andes)} % Organization
	...
	{Jan. 2021 {-} Jul. 2023} % Date(s)
	{
		\begin{cvitems} % Description(s) of tasks/responsibilities
			...
			\item {Gave lectures on topics in Math, Software Development, and Data Science and Engineering at a post-graduate level, including tools like Databricks, Apache Kafka, Spark, and Airflow, among others.}
	...
	{Jan. 2020 {-} Jul. 2020} % Date(s)
	{
		\begin{cvitems}
			...
			\item {Deployed an OLAP solution for more convenient data handling, using SSAS with SSIS jobs for seamless ETL. Time spent on data entry went from three hours every week to 10 minutes.}
